...
from django_spire.core.file.mixins import FileModelMixin
from django_spire.core.file.models import File
...
class FileFormatter:
    ...
    @property
    def location(self):
        return'django-skeleton/' + str(self.related_field) + '/' + '/' + str(self.app_name) + '/' + random_64_char_token() + '/' + self.name
...
class FileContentObjectFormatter(FileFormatter):
    ...
    @property
    def location(self):
        return 'django-skeleton/' + '/' + str(self.content_object._meta.app_label) + '/' + random_64_char_token() + '/' + self.name
