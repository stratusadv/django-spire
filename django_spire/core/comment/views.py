...
from django_spire.core.comment.forms import CommentForm
...
from django_spire.core.views.modal_views import dispatch_modal_delete_form_content
...
def comment_modal_form_content(request, comment_pk: int, obj_pk: int, app_label: str, model_name: str):
    ...
    return TemplateResponse(
        ...
        template='core/comment/form/comment_form.html',
    )
