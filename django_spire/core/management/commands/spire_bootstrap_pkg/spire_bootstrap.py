...
class Reporter:
    ...
    def report_tree_structure(self, base: Path, components: list[str], registered_apps: list[str], template: Path) -> None:
    ...
    def show_tree_from_template(self, template_dir: Path, indent: str = '') -> None:
