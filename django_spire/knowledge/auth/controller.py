...
class BaseKnowledgeAuthController(BaseAuthController):
    def can_access_all_collections(self):
        return self.request.user.has_perm('django_spire_knowledge.can_access_all_collections')
    ...
    def can_change_collection_groups(self):
        return self.request.user.has_perm('django_spire_knowledge.can_change_collection_groups')
