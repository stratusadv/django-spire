...
class AppNotificationJsonViewsTests(BaseTestCase):
    ...
    def test_set_notifications_as_viewed_marks_as_viewed(self):
        self.client.get(reverse('django_spire:notification:app:json:set_viewed'))

        check_response = self.client.get(reverse('django_spire:notification:app:json:check_new'))
