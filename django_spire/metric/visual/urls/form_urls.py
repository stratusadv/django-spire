...
urlpatterns = [
    ...
    path(
        'reference/<int:visual_pk>/create/',
        form_views.create_reference_view,
    ...
    path(
        'region/<int:visual_pk>/connect/',
        region_form_views.connect_region_view,
        name='connect_region',
    ),
    path(
        'region/<int:visual_pk>/connect/save/',
        region_form_views.connect_view,
        name='connect_region_save',
    ),
