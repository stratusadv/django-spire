...
urlpatterns = [
    ...
    path('slide/<int:presentation_pk>/create/', form_views.create_slide_view, name='create_slide'),
    ...
    path('section/<int:slide_pk>/create/', form_views.create_section_view, name='create_section'),
