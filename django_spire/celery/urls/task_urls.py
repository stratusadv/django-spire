...
urlpatterns = [
    ...
    path('item/list/<str:reference_key>/', task_views.task_item_list_view, name='item_list'),
    path('toast/<str:task_id>/', task_views.task_toast_view, name='toast'),
    path('toast/list/<str:reference_key>/', task_views.task_toast_list_view, name='toast_list'),
]
