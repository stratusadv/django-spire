...
class CeleryTaskUrlsTestCase(TestCase):
    def test_task_item_url_resolves(self) -> None:
        ...
        assert url == f'/ds/celery/task/item/{task_id}/'

        resolved = resolve(f'/ds/celery/task/item/{task_id}/')
    ...
    def test_task_toast_url_resolves(self) -> None:
        ...
        assert url == f'/ds/celery/task/toast/{task_id}/'

        resolved = resolve(f'/ds/celery/task/toast/{task_id}/')
        assert resolved.kwargs['task_id'] == task_id

    def test_task_item_list_url_resolves(self) -> None:
        url = reverse('django_spire:celery:task:item_list')

        assert url == '/ds/celery/task/item_list/'

        resolved = resolve('/ds/celery/task/item_list/')
    ...
    def test_task_toast_list_url_resolves(self) -> None:
        ...
        assert url == '/ds/celery/task/toast_list/'

        resolved = resolve('/ds/celery/task/toast_list/')
