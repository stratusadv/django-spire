# Generated by Django 5.2.7 on 2025-10-27 04:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=255, null=True)),
                ('email', models.EmailField(blank=True, max_length=255, null=True)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ai_context_people', related_query_name='ai_context_people', to='django_spire_auth_user.authuser')),
            ],
            options={
