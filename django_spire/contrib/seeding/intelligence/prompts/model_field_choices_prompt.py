...
def model_field_choices_prompt(model_field: Field, choices: TextChoices) -> Prompt:
    ...
    return (
        ...
        .text(
            f'The value for the {field_name} field should only be selected from the following list of choices.'
        )
