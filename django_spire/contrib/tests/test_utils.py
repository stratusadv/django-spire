...
class HumanizeSecondsDurationTestCase(unittest.TestCase):
    ...
    def test_format_duration_included_units_short(self):
        ...
        result = format_duration(
            amount=test_value, included_units=['day', 'hour'], is_short_form=True
        )
        assert result == expected_result
    ...
    def test_format_duration_with_min_unit_included_units_short(self):
        ...
        expected_result = '7d'
        result = format_duration(
            amount=test_value, included_units=['day', 'hour'], min_unit='day', is_short_form=True
        )
        assert result == expected_result
    ...
    def test_format_duration_days_to_hours(self):
        ...
        result = format_duration(amount=test_value, start_unit='day', included_units=['hour'])
        assert result == expected_result
    ...
    def test_format_duration_days_to_hours_short(self):
        ...
        expected_result = '36h'
        result = format_duration(
            amount=test_value, start_unit='day', included_units=['hour'], is_short_form=True
        )
        assert result == expected_result
