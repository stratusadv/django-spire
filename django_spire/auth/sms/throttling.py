...
def throttle_allowed(phone_number: str) -> bool:
    ...
    minute_key = f'django_spire_auth_sms_throttle_minute_{phone_number}_{minute_window}'
    day_key = f'django_spire_auth_sms_throttle_day_{phone_number}_{day_window}'
