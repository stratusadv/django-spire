...
DJANGO_SPIRE_AI_SMS_CODE_ATTEMPT_COUNT_MAX = 5
DJANGO_SPIRE_AI_SMS_CODE_EXPIRY_MINUTES = 10
DJANGO_SPIRE_AI_SMS_SESSION_DURATION_MINUTES_MAX = 480
DJANGO_SPIRE_AI_SMS_SESSION_IDLE_MINUTES_MAX = 30
DJANGO_SPIRE_AI_SMS_THROTTLE_RATE_PER_DAY = 200
DJANGO_SPIRE_AI_SMS_THROTTLE_RATE_PER_MINUTE = 5
