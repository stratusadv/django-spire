...
from django_spire.user_account.authentication.mfa.utils import get_or_generate_user_mfa_code
from django_spire.user_account.authentication.mfa import forms
...
def mfa_form_view(request):
    ...
    return TemplateResponse(
        ...
        template='user_account/authentication/mfa/mfa_form.html'
    )
