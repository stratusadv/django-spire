...
def card_view(request: WSGIRequest) -> TemplateResponse:
    ...
    example = from_file('examples/templates/component/card/example_card.html')
...
def container_view(request: WSGIRequest) -> TemplateResponse:
    ...
    example = from_file('examples/templates/component/container/example_container.html')
...
def dropdown_view(request: WSGIRequest) -> TemplateResponse:
    ...
    example = from_file('examples/templates/component/dropdown/example_dropdown.html')
...
def element_view(request: WSGIRequest) -> TemplateResponse:
    ...
    example = from_file('examples/templates/component/element/example_element.html')
...
def file_view(request: WSGIRequest) -> TemplateResponse:
    ...
    example = from_file('examples/templates/component/file/example_file.html')
...
def form_view(request: WSGIRequest) -> TemplateResponse:
    ...
    example = from_file('examples/templates/component/form/example_form.html')
...
def help_view(request: WSGIRequest) -> TemplateResponse:
    ...
    example = from_file('examples/templates/component/help/example_help.html')
...
def modal_view(request: WSGIRequest) -> TemplateResponse:
    ...
    example = from_file('examples/templates/component/modal/example_modal.html')
...
def navigation_view(request: WSGIRequest) -> TemplateResponse:
    ...
    example = from_file('examples/templates/component/navigation/example_navigation.html')
...
def tab_view(request: WSGIRequest) -> TemplateResponse:
    ...
    example = from_file('examples/templates/component/tab/example_tab.html')
