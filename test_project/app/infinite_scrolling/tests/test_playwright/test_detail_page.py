...
from test_project.app.infinite_scrolling.tests.test_playwright.pages.detail_page import (
...
class TestDetailPage:
    def test_detail_page_loads(
        self, authenticated_page: Page, live_server: _LiveServer, transactional_db: None
    ) -> None:
        item = InfiniteScrolling.objects.create(name='Test Item', description='Test Description')
    ...
    def test_detail_page_shows_attributes(
        self, authenticated_page: Page, live_server: _LiveServer, transactional_db: None
    ) -> None:
        item = InfiniteScrolling.objects.create(
            name='Detailed Item', description='Detailed Description'
        )
