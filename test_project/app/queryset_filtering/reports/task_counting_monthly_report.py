...
class TaskCountingMonthlyReport(BaseReport):
    ...
    def run(
        ...
        self.add_divider_row(
            'Main Tasks',
            description=f'This section shows the main task! {person=} and {other_people=}',
        )
        ...
        for _ in range(1, 60):
            self.add_row(
                ...
                cell_sub_values=[start_date, None, None, None, None, None, None, 'Tacos'],
            )
        ...
        self.add_blank_row()
        self.add_blank_row(
            text='This some extra information on how tasks are evaluated and make sure to take time to read this and be amazed!!!'
        )
        self.add_blank_row()
