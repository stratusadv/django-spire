# Generated by Django 5.2.2 on 2025-06-28 19:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('best_friend', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='test_project_test_model.testmodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=32)),
                ('last_name', models.CharField(max_length=32)),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='children', related_query_name='child', to='test_project_test_model.testmodel')),
            ],
            options={
