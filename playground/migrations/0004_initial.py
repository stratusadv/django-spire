...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('playground', '0003_delete_testmodel'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('best_friend', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='playground.testmodel')),
            ],
            options={
